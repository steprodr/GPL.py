...
#Important Imported Imports
import credentials
import requests
import csv

# Defining our variables. 
#The credentials stored in credentials.py in the same directory as where this file is located
# the files we are going to read and write too
